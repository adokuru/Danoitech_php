      ...
      <div class="container">
        <div class="text-center">
          ...
          <div class=" flex-wrap pt-2"> 
            <a class="mr-4" href=""><img alt="" src="images/app-store.png" style="width: 200px; height: 60px;"></a>
            <a href=""><img alt="" src="images/google-play-store.png" style="width: 200px; height: 60px;"></a> </div>
      </div>
    </section>
    <!-- Mobile App end --> 
